...
export default function AddCardPage() {
  return (
    <DemoShell
      ...
      description="This screen keeps the same refined mobile look while working naturally in the browser for demos and presentations."
    ...
    >
      <div className="screen with-nav">
        ...
        <CardVisual brand="Mastercard" nickname="Primary card" number="•••• 4291" />
